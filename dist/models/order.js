...
var Order = /** @class */ (function () {
    ...
    Order.prototype.create = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, user_id, status_1, order_create, sql_2, order_id, create_order_product, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        order_create = _a.sent();
                        sql_2 = "insert into order_product(product_id,order_id,quantity) values($1,$2,$3) returning * ;";
                        order_id = order_create.rows[0].id;
                        return [4 /*yield*/, connection.query(sql_2, [
                                order.Prod_collection.product_id,
                                order_id,
                                order.Prod_collection.quantity
                            ])];
                    case 3:
                        create_order_product = _a.sent();
                        console.log(order_create.rows[0]);
                        connection.release();
                        return [2 /*return*/, __assign(__assign({}, order_create.rows[0]), { Product_collection: create_order_product.rows[0] })];
                    case 4:
                        err_1 = _a.sent();
    ...
    Order.prototype.current = function (id) {
        return __awaiter(this, void 0, void 0, function () {
