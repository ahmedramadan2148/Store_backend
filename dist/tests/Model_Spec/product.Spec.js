...
describe('Test Product model', function () {
    describe('Test Product method', function () {
        var product_test = {
            prodname: "computer",
            price: 23,
        };
        ...
        beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, productModel.create(product_test)];
                    case 1:
                        result = _a.sent();
        ...
        it("get one product", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, productModel.readOne(product_test.id)];
                    case 1:
                        result = _a.sent();
        ...
        it("create one product", function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, productModel.create(product_test2)];
                    case 1:
                        result = _a.sent();
        ...
        it("show all product", function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, productModel.readAll()];
                    case 1:
                        result = _a.sent();
