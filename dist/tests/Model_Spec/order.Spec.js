...
var order;
describe("Test Order model function ", function () {
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var resultProduct, resultUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, product.create(product_test)];
                case 1:
                    resultProduct = _a.sent();
                    product_test.id = resultProduct.id;
                    return [4 /*yield*/, user.create(user_test)];
                case 2:
                    resultUser = _a.sent();
    ...
    it("create one order ", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it("get current oreder", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, orderModel.current(user_test.id)];
                case 1:
                    result = _a.sent();
                    expect(result.status)
                        .toBe(order.orders.status);
